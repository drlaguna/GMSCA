...
#' correction, then a regression correctio to reduce bias of using too big enrichment sets. This paremeter is True by default.
...
#' @param celltypes Vector of charactr with the name of the meta-enrichment types.
...
#' module names is provided the significanceThreshold parameter is ignored.
#' @param markers.path Folder containing user-defined lists of genes to be used as marker genes to determine
